...
class WC_PDF_Product_Vouchers_Customizer {
	...
	public function add_customizer_controls( $wp_customize ) {
		...
		require_once( wc_pdf_product_vouchers()->get_plugin_path() . '/includes/customizer/class-wc-pdf-product-vouchers-barcode-customize-position-control.php' );
	...
	public function customizer_controls_scripts() {
		...
		wp_localize_script( 'woocommerce-pdf-product-vouchers-customizer-control-scripts', 'woocommerce_vouchers_admin_customizer', array(
			'i18n' => array(
				...
				/* translators: %s - Message for QR code scanning support. */
			...
			'wc_gte_3_2'             => Framework\SV_WC_Plugin_Compatibility::is_wc_version_gte( '3.2' )
		) );
