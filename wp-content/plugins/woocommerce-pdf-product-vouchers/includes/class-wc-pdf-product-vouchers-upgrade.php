...
class WC_PDF_Product_Vouchers_Upgrade extends Framework\Plugin\Lifecycle {
	 ...
	 * Runs the install.
	 *
	 * TODO remove this method by version 3.8.0 {FN 2018-07-06}
	 *
	 * @since 3.0.0
	...
	public function run_install_scripts() {
		...
		_deprecated_function( 'WC_PDF_Product_Vouchers_Upgrade::run_install_scripts()', '3.6.0' );
	...
	public function run_update_scripts( $installed_version ) {
		...
		_deprecated_function( 'WC_PDF_Product_Vouchers_Upgrade::run_update_scripts()', '3.6.0' );
