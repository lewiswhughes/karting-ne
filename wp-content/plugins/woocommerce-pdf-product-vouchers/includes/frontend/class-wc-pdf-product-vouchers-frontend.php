...
class WC_PDF_Product_Vouchers_Frontend {
	...
	public function __construct() {
		...
		$this->my_account = wc_pdf_product_vouchers()->load_class( '/includes/frontend/class-wc-pdf-product-vouchers-my-account.php', '\\SkyVerge\\WooCommerce\\PDF_Product_Vouchers\\Frontend\\My_Account' );
	 ...
	 *
	 * TODO remove deprecated methods one year from date of deprecation or by next major release {FN 2019-03-11}
	 * @since 3.5.4
	 * @deprecated
	 *
	 * @param string $deprecated called method (maybe deprecated)
	 * @param array $args optional arguments passed in method call
	 * @return mixed|null
	 */
	public function __call( $deprecated, $args ) {

		switch ( $deprecated ) {

			/** @deprecated since 3.5.4 - remove by version 4.0.0 or by March 2020 */
			case 'add_endpoints' :
				_deprecated_function( __METHOD__, '3.5.4', '\\SkyVerge\\WooCommerce\\PDF_Product_Vouchers\\Frontend\\My_Account::add_endpoints()' );
				return $this->get_my_account_instance()->add_endpoints();

			/** @deprecated since 3.5.4 - remove by version 4.0.0 or by March 2020 */
			case 'add_query_vars' :
				_deprecated_function( __METHOD__, '3.5.4', '\\SkyVerge\\WooCommerce\\PDF_Product_Vouchers\\Frontend\\My_Account::add_query_vars()' );
				return $this->get_my_account_instance()->add_query_vars( $args );

			/** @deprecated since 3.5.4 - remove by version 4.0.0 or by March 2020 */
			case 'add_voucher_menu_item' :
				_deprecated_function( __METHOD__, '3.5.4', '\\SkyVerge\\WooCommerce\\PDF_Product_Vouchers\\Frontend\\My_Account::add_voucher_menu_item()' );
				return $this->get_my_account_instance()->add_voucher_menu_item( $args );

			/** @deprecated since 3.5.4 - remove by version 4.0.0 or by March 2020 */
			case 'endpoint_title' :
				_deprecated_function( __METHOD__, '3.5.4', '\\SkyVerge\\WooCommerce\\PDF_Product_Vouchers\\Frontend\\My_Account::handle_endpoint_title()' );
				return $this->get_my_account_instance()->handle_endpoint_titles( $args );
