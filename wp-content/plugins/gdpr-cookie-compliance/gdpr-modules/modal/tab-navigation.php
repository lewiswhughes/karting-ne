...
<?php if ( $content->cookiepolicy->show ) : ?>
    <li class="menu-item-moreinfo menu-item-off">
        <button data-href="#cookie_policy_modal" class="moove-gdpr-tab-nav" rel="nofollow"><span class="gdpr-icon moovegdpr-policy"></span> <span class="gdpr-nav-tab-title"><?php echo $content->cookiepolicy->nav_label; ?></span></button>
    </li>
<?php endif; ?>